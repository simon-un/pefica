...
%
% Esta versión está en la carpeta PARBID, e incluye:
% Análisis elástico lineal para armaduras planas. Puede leer datos y escribir 
...
fprintf('----------------------------------------------------------------- \n');
fprintf('PARBID/PEFICA: Analisis elastico lineal de armaduras planas \n');
