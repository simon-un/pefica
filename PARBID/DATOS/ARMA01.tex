...
\draw (3.000000,4.000000)--(9.000000,4.000000) node[nudo] {3}; 
...
\fill (6.000000,0.000000) circle (\r) node {2}; 
\fill (12.000000,0.000000) circle (\r) node {3}; 
\fill (3.000000,4.000000) circle (\r) node {4}; 
\fill (9.000000,4.000000) circle (\r) node {5}; 
\end{scope} 
% dibujar apoyos 
