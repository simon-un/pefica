...
\begin{scope}[elem] 
\draw (0.000000,0.000000)--(0.750000,0.000000) node[nudo] {1}; 
\draw (0.750000,0.000000)--(1.500000,0.000000) node[nudo] {2}; 
\draw (1.500000,0.000000)--(2.250000,0.000000) node[nudo] {3}; 
\draw (2.250000,0.000000)--(3.000000,0.000000) node[nudo] {4}; 
\draw (3.000000,0.000000)--(3.750000,0.000000) node[nudo] {5}; 
\draw (3.750000,0.000000)--(4.500000,0.000000) node[nudo] {6}; 
\draw (4.500000,0.000000)--(5.250000,0.000000) node[nudo] {7}; 
\draw (5.250000,0.000000)--(6.000000,0.000000) node[nudo] {8}; 
\draw (6.000000,0.000000)--(9.000000,0.000000) node[nudo] {9}; 
\draw (9.000000,0.000000)--(12.000000,0.000000) node[nudo] {10}; 
\end{scope} 
% dibujar nudos 
...
\fill (0.750000,0.000000) circle (\r) node {2}; 
\fill (1.500000,0.000000) circle (\r) node {3}; 
\fill (2.250000,0.000000) circle (\r) node {4}; 
\fill (3.000000,0.000000) circle (\r) node {5}; 
\fill (3.750000,0.000000) circle (\r) node {6}; 
\fill (4.500000,0.000000) circle (\r) node {7}; 
\fill (5.250000,0.000000) circle (\r) node {8}; 
\fill (6.000000,0.000000) circle (\r) node {9}; 
\fill (9.000000,0.000000) circle (\r) node {10}; 
\fill (12.000000,0.000000) circle (\r) node {11}; 
\end{scope} 
% dibujar apoyos 
