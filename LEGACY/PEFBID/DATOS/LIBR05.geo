...
Plane Surface(4) = {4};
Physical Point("LOAD FY=2.0") = {9};
Physical Curve("DISP UY=0") = {1};
Physical Curve("DISP UX=0") = {6, 7, 8, 9};
Physical Surface("CATE  EYOU=200E6 POIS=0.25 TESP=0.01") = {1, 2, 3, 4};
Transfinite Curve {5, 4, 3, 2, 1} = 4*nd+1 Using Progression 1;
Transfinite Curve {9, 13, 8, 12, 7, 11} = 2*nd+1 Using Progression 1;
Transfinite Curve {6, 10} = 1+nd Using Progression 1;
