...
function IMRESU(NNUD,ENNU,UXY,FNX,SRE,ERE)
...
%           FNX:  tabla de fuerzas aplicadas directamente en los nudos (reacciones)
...
%           ERE:  tabla de las deformaciones en los elementos
    ...
    fprintf('\nFuerzas aplicadas directamente en los nudos (reacciones) \n');
    fprintf('  INUD          FX          FY \n');
    TEM = [1:NNUD;FNX'];
    fprintf('%6i %+10.4e %+10.4e \n',TEM);
