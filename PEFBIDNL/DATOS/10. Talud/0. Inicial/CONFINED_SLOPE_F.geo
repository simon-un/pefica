...
Plane Surface(1) = {1};
Plane Surface(2) = {2};
MeshSize {1, 2, 3, 8, 9, 10, 11, 12} = 12;
MeshSize {5, 6, 7, 8, 4} = 2;
Physical Curve("DISP UX=0 UY=0") = {1,2,9};
Physical Point("LOAD FY=-40E3") = {11};
Physical Point("CURV HO=UY VE=FY") = {11};
Physical Surface("CATE EYOU=2.8E7 POIS=0.3 GAMM=25 TESP=1 TIPR=21 EPLA=0 SIGY=3E3 TYMO=21") = {1};
Physical Surface("CATE EYOU=8E10 POIS=0.3 GAMM=25 TESP=1 TIPR=21 EPLA=6.50E3 SIGY=3E3 TYMO=11") = {2};