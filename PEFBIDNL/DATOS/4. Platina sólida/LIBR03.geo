...
Plane Surface(4) = {4};
Physical Curve("LOAD FY=1.0") = {5};
Physical Point("CURV HO=UY VE=FY") = {9};
Physical Curve("DISP UY=0") = {1};
Physical Curve("DISP UX=0") = {6, 7, 8, 9};
Physical Surface("CATE EYOU=200E6 POIS=0.25 TESP=0.01 TIPR=20 EPLA=1E6 SIGY=350E3 TYMO=23") = {1, 2, 3, 4};
